...
class CompressionTool(Toolkit):
    ...
    def __init__(self, project_tool: ProjectTool):
        super().__init__(
            ...
            instructions=[
                "Use this tool when conversation history becomes too long",
                "Automatically triggered when approaching token limits",
                "Saves compressed context summaries to project folder",
                "Maintains conversation continuity while managing memory"
            ]
        )
    ...
    def _save_summary_to_file(self, summary: str, messages_compressed: int, messages_retained: int) -> str:
        ...
        try:
            ...
            if project_folder:
                ...
                return f"No project folder - summary not saved"
